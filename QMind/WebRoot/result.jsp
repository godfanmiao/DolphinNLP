...
{
	%>
	<div class="bd answer" id="<%=res.getAid() %>">
	<div class="line content"><pre id="<%=res.getAid() %>" accuse="aContent" class="best-text mb-10">
	<%
